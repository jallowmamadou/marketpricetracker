...
<div id="edit_{{$ahouse['hous_id']}}" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
    <h3 id="myModalLabel">Edit house</h3>
  </div>
{{Form::model($ahouse,['route'=>[ 'houses.update', $ahouse['hous_id'] ], 'method'=>'PATCH'],['class'=>'form-snippet'])}}
